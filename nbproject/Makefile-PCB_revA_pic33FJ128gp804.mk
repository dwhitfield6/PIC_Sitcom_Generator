...
SOURCEFILES_QUOTED_IF_SPACED=main.c MISC.c SPI.c FAT.c DAC.c RTCC.c SD.c WAV.c UART.c PIR.c PWM.c SWITCH.c CONFIGURATION.c TIMERS.c ADC.c SYSTEM.c USER.c INTERRUPTS.c DMA.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.o ${OBJECTDIR}/MISC.o ${OBJECTDIR}/SPI.o ${OBJECTDIR}/FAT.o ${OBJECTDIR}/DAC.o ${OBJECTDIR}/RTCC.o ${OBJECTDIR}/SD.o ${OBJECTDIR}/WAV.o ${OBJECTDIR}/UART.o ${OBJECTDIR}/PIR.o ${OBJECTDIR}/PWM.o ${OBJECTDIR}/SWITCH.o ${OBJECTDIR}/CONFIGURATION.o ${OBJECTDIR}/TIMERS.o ${OBJECTDIR}/ADC.o ${OBJECTDIR}/SYSTEM.o ${OBJECTDIR}/USER.o ${OBJECTDIR}/INTERRUPTS.o ${OBJECTDIR}/DMA.o
...
# Source Files
SOURCEFILES=main.c MISC.c SPI.c FAT.c DAC.c RTCC.c SD.c WAV.c UART.c PIR.c PWM.c SWITCH.c CONFIGURATION.c TIMERS.c ADC.c SYSTEM.c USER.c INTERRUPTS.c DMA.c
...
${OBJECTDIR}/DMA.o: DMA.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/DMA.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  DMA.c  -o ${OBJECTDIR}/DMA.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/DMA.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -mlarge-code -mlarge-data -mlarge-scalar -mconst-in-code -O0 -merrata=all -msmart-io=1 -Wall -msfr-warn=off
...
${OBJECTDIR}/DMA.o: DMA.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/DMA.o.d 
	@${RM} ${OBJECTDIR}/DMA.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  DMA.c  -o ${OBJECTDIR}/DMA.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/DMA.o.d"        -g -omf=elf -mlarge-code -mlarge-data -mlarge-scalar -mconst-in-code -O0 -merrata=all -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/DMA.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
